...
export default function TransactionForm() {
  ...
  const handleNumberChange = (e) => {
    ...
    setValue({
      ...value,
      amount : Number(raw).toLocaleString("id-ID")
    }); // format: 1.000.000
  };
    ...
    <div className="p-8">
      <form action="" className="space-y-4">
        <div className="space-y-2">
          ...
          <input name="description" value={value.description} onChange={(e) => handleChange(e)} id="deskripsi" type="text" placeholder="Deskripsi" className="w-full border border-slate-300 rounded px-4 py-2 focus:outline-none focus:border-1 transition-all" />
        </div>
        <div className="space-y-2">
          ...
          <div className="relative">
            <input value={value.amount} onChange={(e) => handleNumberChange(e)} id="nominal" type="text" placeholder="0" className="w-full border border-slate-300 rounded px-4 py-2 focus:outline-none focus:border-1 ps-12 transition-all" />
